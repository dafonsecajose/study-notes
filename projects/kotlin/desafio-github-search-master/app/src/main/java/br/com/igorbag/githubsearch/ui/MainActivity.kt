...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        ...
        btnConfirmar.setOnClickListener {
            if(!nomeUsuario.text.isEmpty()){
                ...
                Toast.makeText(this, "Digite o nome de usuário válido!", Toast.LENGTH_LONG).show()
            }
        }
    ...
    private fun saveUserLocal() {
        ...
        var userNameEditor = sharedPreferences.edit()
        userNameEditor.putString("USER_NAME", nomeUsuario.text.toString())
    ...
    private fun showUserName() {
        ...
        val sharedPreferences = getSharedPreferences("USER_NAME", Context.MODE_PRIVATE)
        var  nameShared = sharedPreferences.getString("USER_NAME", "")
        if(nameShared != null){
            nomeUsuario.text = Editable.Factory.getInstance().newEditable(nameShared)
        }
    }
        ...
        githubApi.getAllRepositoriesByUser(nomeUsuario.text.toString()).enqueue(object : Callback<List<Repository>> {
            override fun onResponse(
                ...
                if(response.isSuccessful){
                    ...
                    Toast.makeText(applicationContext, "Algo deu errado, por favor tente novamente mais tarde", Toast.LENGTH_LONG).show()
                }
            }
